class RecommendationsController < ApplicationController
  ...
  def index
    ...
    @recommendations = @q.result(:distinct => true).includes(:sender, :recipient).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def recommendation_params
      params.require(:recommendation).permit(:body, :sender_id, :recipient_id)
    end
end
